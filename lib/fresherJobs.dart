...
//     final prefs = await SharedPreferences.getInstance();
//     final String? jobsData = prefs.getString('jobsData');
//
//     if (jobsData != null) {
//       return json.decode(jobsData) as List<dynamic>;
//     } else {
//       final apiService = ApiService('http://13.127.81.177:8000/api/fresherjob/');
//       final jobs = await apiService.fetchData();
//
//       await prefs.setString('jobsData', json.encode(jobs));
//       return jobs;
//     }
//   }
//
...
//     final prefs = await SharedPreferences.getInstance();
//     final String? applicationsData = prefs.getString('applicationsData');
//
//     if (applicationsData != null) {
//       return json.decode(applicationsData) as List<dynamic>;
//     } else {
//       final apiService = ApiService('http://13.127.81.177:8000/api/job-applications/');
//       final applications = await apiService.fetchData();
//       await prefs.setString('applicationsData', json.encode(applications));
//       return applications;
//     }
//   }
//
